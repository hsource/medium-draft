...
var _default = function _default(rawHTML) {
...
(function () {
  ...
  reactHotLoader.register(htmlToStyle, 'htmlToStyle', 'src/importer.js');
  reactHotLoader.register(htmlToEntity, 'htmlToEntity', 'src/importer.js');
  reactHotLoader.register(htmlToBlock, 'htmlToBlock', 'src/importer.js');
  reactHotLoader.register(options, 'options', 'src/importer.js');
  reactHotLoader.register(setImportOptions, 'setImportOptions', 'src/importer.js');
  reactHotLoader.register(_default, 'default', 'src/importer.js');
  leaveModule(module);
})();
