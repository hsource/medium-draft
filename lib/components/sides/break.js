...
(function () {
  ...
  reactHotLoader.register(BreakButton, 'BreakButton', 'src/components/sides/break.js');
  reactHotLoader.register(_default, 'default', 'src/components/sides/break.js');
  leaveModule(module);
})();
