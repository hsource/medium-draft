...
(function () {
  ...
  reactHotLoader.register(TodoBlock, 'TodoBlock', 'src/components/blocks/todo.js');
  reactHotLoader.register(_default, 'default', 'src/components/blocks/todo.js');
  leaveModule(module);
})();
