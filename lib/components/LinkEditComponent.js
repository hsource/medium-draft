...
var LinkEditComponent = function (_React$Component) {
  ...
  function LinkEditComponent(props) {
    ...
    _this.hasPosition = function (position) {
      if (Object.keys(_this.state.position).length === 0) {
        return false;
      }
  ...
  _createClass(LinkEditComponent, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      if (this.renderedOnce) {
        ...
        var ret = !this.hasPosition(nextState.position) || blockKey !== nextProps.blockKey || entityKey !== nextProps.entityKey;
        if (ret) {
...
var _default = LinkEditComponent;
...
(function () {
  ...
  reactHotLoader.register(getRelativeParent, 'getRelativeParent', 'src/components/LinkEditComponent.js');
  reactHotLoader.register(LinkEditComponent, 'LinkEditComponent', 'src/components/LinkEditComponent.js');
  reactHotLoader.register(_default, 'default', 'src/components/LinkEditComponent.js');
  leaveModule(module);
})();
