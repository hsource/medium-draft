...
(function () {
  ...
  reactHotLoader.register(Toolbar, 'Toolbar', 'src/components/toolbar.js');
  reactHotLoader.register(BLOCK_BUTTONS, 'BLOCK_BUTTONS', 'src/components/toolbar.js');
  reactHotLoader.register(INLINE_BUTTONS, 'INLINE_BUTTONS', 'src/components/toolbar.js');
  reactHotLoader.register(_default, 'default', 'src/components/toolbar.js');
  leaveModule(module);
})();
