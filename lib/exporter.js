...
(function () {
  ...
  reactHotLoader.register(styleToHTML, 'styleToHTML', 'src/exporter.js');
  reactHotLoader.register(blockToHTML, 'blockToHTML', 'src/exporter.js');
  reactHotLoader.register(entityToHTML, 'entityToHTML', 'src/exporter.js');
  reactHotLoader.register(options, 'options', 'src/exporter.js');
  reactHotLoader.register(setRenderOptions, 'setRenderOptions', 'src/exporter.js');
  reactHotLoader.register(_default, 'default', 'src/exporter.js');
  leaveModule(module);
})();
