...
(function () {
  ...
  reactHotLoader.register(StringToTypeMap, 'StringToTypeMap', 'src/util/beforeinput.js');
  reactHotLoader.register(beforeInput, 'beforeInput', 'src/util/beforeinput.js');
  reactHotLoader.register(_default, 'default', 'src/util/beforeinput.js');
  leaveModule(module);
})();
