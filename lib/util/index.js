...
(function () {
  ...
  reactHotLoader.register(getSelectionRect, 'getSelectionRect', 'src/util/index.js');
  reactHotLoader.register(getSelection, 'getSelection', 'src/util/index.js');
  reactHotLoader.register(getSelectedBlockNode, 'getSelectedBlockNode', 'src/util/index.js');
  leaveModule(module);
})();
