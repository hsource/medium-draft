...
(function () {
  ...
  reactHotLoader.register(getDefaultBlockData, 'getDefaultBlockData', 'src/model/index.js');
  reactHotLoader.register(getCurrentBlock, 'getCurrentBlock', 'src/model/index.js');
  reactHotLoader.register(addNewBlock, 'addNewBlock', 'src/model/index.js');
  reactHotLoader.register(resetBlockWithType, 'resetBlockWithType', 'src/model/index.js');
  reactHotLoader.register(updateDataOfBlock, 'updateDataOfBlock', 'src/model/index.js');
  reactHotLoader.register(addNewBlockAt, 'addNewBlockAt', 'src/model/index.js');
  reactHotLoader.register(isCursorBetweenLink, 'isCursorBetweenLink', 'src/model/index.js');
  leaveModule(module);
})();
